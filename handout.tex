...
\pi(q, S) \;=\; \underbrace{P\,q}_{\text{revenue}}
           ...
           \;-\; \underbrace{c_0\,q}_{\text{base cost}}
           \;-\; \underbrace{c_1\,(S_{\max}-S)\,q}_{\text{depth cost}}
\]
\end{infobox}
...
$c_0 \cdot q$ & Base operating cost per unit pumped & $c_0 = 2$ \\[4pt]
$c_1 (S_{\max}-S) q$ & Depth cost --- the lower the water table, the more expensive to pump & $c_1 = 0.006$ \\
\bottomrule
\end{tabular}
